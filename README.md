...
This project analyses the relationship between Generative AI use and student outcomes. The objective is to examine whether the number of hours students spend using AI is associated with academic performance, skill retention, anxiety, and burnout risk.
